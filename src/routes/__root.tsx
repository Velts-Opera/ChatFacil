...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Comunica AI — Transforme seu WhatsApp em uma máquina de vendas" },
      { property: "og:description", content: "Plataforma de atendimento, CRM e automação para WhatsApp e Instagram. Automatize respostas, qualifique leads e venda mais com IA." },
